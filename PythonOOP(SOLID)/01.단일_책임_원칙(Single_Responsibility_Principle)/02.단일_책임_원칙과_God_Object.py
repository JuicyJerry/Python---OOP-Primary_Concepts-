...
"""모든 클래스는 단 한가지의 책임만을 갖고, 클래스 안에 정의되어 있는 모든 기능은, 이 하나의 채김을 수행하는데 집중
되어 있어야 한다."""

#Q1. 클래스가 하는 일 중 한 가지 책임이란?
#A1. 사람들마다 생각이 다르고, 상황에 따라서도 다릅니다!
"""Rober C. Martin: 단일 책임 원칙은 같이 수정해야될 것들은 묶고, 따로 수정해야될 것들은 분리하는 것"""
# GOD OBJECT(신 객체): 하나의 클래스가 많은 책임을 직접 수행하는 객체 - 지양
"""
단일 책임 원칙 전 ->책임: 연료, 물자, 선원, 엔진 (* 변경 사항이 발생 시, 많은 시간이 소요됨)
단일 책임 원칙 후 -> 책임: 연료, 책임: 물자, 책임: 선원, 책임: 엔진 """
